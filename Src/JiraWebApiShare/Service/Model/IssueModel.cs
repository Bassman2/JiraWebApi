...
/// </remarks>
public sealed class IssueModel // : ISerializable
{
    ...
    public IssueModel(string issueKey)
    {
        this.SerializeMode = SerializeMode.Link;
        this.Key = issueKey;
        this.customFields = new List<CustomField>();
...
//                    JsonTrace.WriteLine("---Fields ready---");
    ...
    */
    ...
    public static bool operator ==(IssueModel issue1, IssueModel issue2)
    {
    ...
    public static bool operator ==(string key, IssueModel issue)
    {
    ...
    public static implicit operator string?(IssueModel? issue)
    {
        return issue?.Key;
    }
